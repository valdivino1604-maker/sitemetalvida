...
.lobao-launcher{position:relative;width:76px;height:76px;display:grid;place-items:center;border:0;border-radius:50%;background:#d20a0a;color:#fff;cursor:pointer;box-shadow:0 18px 42px rgba(0,0,0,.42);transition:transform .18s ease,background .18s ease}
.lobao-launcher:hover,.lobao-launcher:focus-visible{transform:translateY(-2px);background:#ff2b2b;outline:3px solid rgba(229,9,20,.28);outline-offset:4px}
.lobao-launcher-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:50%;border:2px solid rgba(255,255,255,.86);background:#0b0b0b;font-size:30px;font-weight:1000;line-height:1}
.lobao-notice{position:absolute;right:88px;top:50%;transform:translateY(-50%);white-space:nowrap;background:#0b0b0b;border:1px solid rgba(255,255,255,.16);border-radius:8px;padding:9px 12px;color:#fff;font-size:13px;font-weight:900;box-shadow:0 12px 28px rgba(0,0,0,.32)}
.lobao-notice::after{content:"";position:absolute;right:-6px;top:50%;width:10px;height:10px;transform:translateY(-50%) rotate(45deg);background:#0b0b0b;border-top:1px solid rgba(255,255,255,.16);border-right:1px solid rgba(255,255,255,.16)}
.lobao-panel{position:absolute;right:0;bottom:92px;width:min(390px,calc(100vw - 32px));height:min(620px,calc(100vh - 124px));display:grid;grid-template-rows:auto 1fr auto auto;overflow:hidden;border-radius:8px;background:#fff;color:#111;box-shadow:0 24px 60px rgba(0,0,0,.48);border:1px solid rgba(255,255,255,.2);opacity:0;pointer-events:none;transform:translateY(14px) scale(.96);transition:opacity .18s ease,transform .18s ease}
...
@media(max-width:900px){#lobao-chat-root{right:14px;bottom:14px}.lobao-notice{display:none}}`;
